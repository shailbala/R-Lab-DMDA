...
x <- scan("/Day 02/scan.txt", what=list(age=0, name=""))
...
x <- scan("/home/magiclair/Documents/00Notes/DMDA/Lab/Day 02/scan.txt", 
...
list.files(path = "/home/magiclair/Documents/00Notes/DMDA/Lab/") # to list files in any directory

## To read a file into memory using scan():
## assuming that the file 'file_name' is numeric

## Here is a trick:
file_name = "/home/magiclair/Documents/00Notes/DMDA/Lab/Day 02/data.txt"
file_name
...
d <- scan(file = "/home/magiclair/Documents/00Notes/DMDA/Lab/Day 02/data.txt")
d
...
list.files("/home/magiclair/Documents/00Notes/DMDA/Lab/Day 02/")
read.table("/home/magiclair/Documents/00Notes/DMDA/Lab/Day 02/daphnia.txt", header = T)

## Couple with assignment and put into parentheses (to print):
(daphnia.data <- read.table("/home/magiclair/Documents/00Notes/DMDA/Lab/Day 02/daphnia.txt", header = T))

## To see what default directory is:
getwd()

## To change it to c:/temp (or any other directory):
setwd("/home/magiclair/Documents/00Notes/DMDA/Lab/Day 02/")
